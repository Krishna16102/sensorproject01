...
class DataTransformation:
    ...
    def get_data(feature_store_file_path:str) ->pd.DataFrame:
        ...
        try:
            ...
            data.rename(columns={"Good/Bad":TARGET_COLUMN},inplace=True) # replace the Good/Bad column  with Target Column 
            return data
    ...
    def initiate_data_transformation(self):
        ...
        try:
            ...
            y= np.where(dataframe[TARGET_COLUMN]==-1,0,1)  # we are replacing the -1 with 0
